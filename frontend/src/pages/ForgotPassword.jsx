  ...
  return (
    ...
    <div className='min-h-screen flex items-center w-full justify-center p-4 mb-6' style={{ backgroundColor: '#fff9f6' }} >
       <div className='bg-white rounded-xl shadow-lg w-full max-w-md p-8'>
        ...
        <button className={`w-full py-2 rounded-md text-white font-semibold mt-4 hover:bg-orange-600 transition-colors bg-[#ff4d2d] cursor-pointer`} onClick={handleSendOtp} disabled={loading}>{loading ? <ClipLoader size={20} color='white'/>:"Send OTP"}</button>
        ...
        <button className={`w-full py-2 rounded-md text-white font-semibold mt-4 hover:bg-orange-600 transition-colors bg-[#ff4d2d] cursor-pointer`} onClick={handleVerifyOtp} disabled={loading}>{loading ? <ClipLoader size={20} color='white'/>:"VERIFY OTP"}</button>
        <p className="text-red-500 text-center">{err}</p>
        </div>
        )}
        ...
        <button className={`w-full py-2 rounded-md text-white font-semibold mt-4 hover:bg-orange-600 transition-colors bg-[#ff4d2d] cursor-pointer`} onClick={handleResetPassword} disabled={loading} >{loading ? <ClipLoader size={20} color='white'/>:"Reset Password"}</button>
        <p className="text-red-500 text-center">{err}</p>
        </div>
        )}
